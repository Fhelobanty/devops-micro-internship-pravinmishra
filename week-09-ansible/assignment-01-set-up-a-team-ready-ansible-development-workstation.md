...
![alt text](screenshots/As1T1ss1.png)
...
![alt text](screenshots/As1T2ss2.png)
...
![alt text](screenshots/As1T3ss3.png)
...
![alt text](screenshots/As1T3ss4.png)
...
![alt text](screenshots/As1T4ss5.png)
...
![alt text](screenshots/As1T4ss6.png)
...
![alt text](screenshots/As1T5ss7.png)
...
![alt text](screenshots/As1T6ss8.png)
...
![alt text](screenshots/As1T7ss9.png)
...
![alt text](screenshots/As1T7ss10.png)
...
![alt text](screenshots/As1T8ss11.png)
...
![alt text](screenshots/As1T8ss12.png)
...
One team-friendly feature is the use of a project-level Python virtual environment (.venv) and pre-commit configuration. This gives team members a consistent environment and automatically checks YAML and Ansible files before they are committed.

---

**2. What is one pitfall you avoided while completing the setup?**

I avoided installing Ansible and its supporting tools globally with pip. Instead, I installed them inside the project's .venv, which keeps the project dependencies isolated and prevents conflicts with the system Python environment.

---

**3. Why should Ansible be installed inside a Python virtual environment?**

Ansible should be installed inside a Python virtual environment because it isolates Ansible and its dependencies from the system Python installation. This makes the environment easier to manage, reduces dependency conflicts, and allows the project to use specific tool versions consistently.

---

**4. Why must SSH private keys and `.venv/` remain outside version control?**

SSH private keys must remain outside version control because they are secret authentication credentials. If committed to Git, someone who obtains the repository could potentially use the key to access systems.
The .venv/ directory should also remain outside version control because it contains locally installed dependencies and environment-specific files. Instead of committing it, the project stores the required packages in requirements.txt so the environment can be recreated when needed.
