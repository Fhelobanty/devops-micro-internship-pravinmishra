...
![GitInit](screenshots/As1T1ss1.png)
...
The .git folder is a hidden folder that stores all the history and tracking information of a project. It’s important because it’s what makes my folder a Git repository, without it, Git won’t work. Anything i want to do like push,pull, create branch this is where Git store this configuration related to this repository.
...
![Local-List](screenshots/As1T2ss3.png)
